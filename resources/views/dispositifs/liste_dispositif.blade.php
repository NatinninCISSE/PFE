        ...
        <div class="details">
                <div class="recentOrders">
                    <div class="cardHeader">
                        ...
                        <a href="{{ route('dispositifs.creer_dispositif') }}" class="btn btn-primary mb-3">Ajouter un dispositif</a>
                    </div>
                    <table>
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="bouton">
                                  ...
                                  <a href="{{ route('dispositifs.modifier_dispositif', $dispositif->id) }}" class="btn-modifier"><ion-icon name="create-outline"></ion-icon></a>
                                  
                                  
                                  <form class="supprime" action="{{ route('dispositifs.destroy', $dispositif->id) }}" method="POST">
                                  @csrf
                                  @method('DELETE')
                                  <button type="submit" class="btn-supprimer" onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce dispositif?')">
