    ...
    <div class="container">
        ...
        @csrf
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="nom_dispositif" name="nom_dispositif" placeholder="Entrez le nom du dispositif">
                        
            </div>
            <div class="mb-3">
                <label for="description_dispositif" class="form-label">Description</label>
            ...
            <a href="{{ route('dispositifs') }}" class="btn btn-danger">Retour</a>
