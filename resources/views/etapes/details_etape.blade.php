    ...
    <div class="details">
                <div class="recentOrders">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="bouton">
                                  ...
                                  <a href="{{ route('taches.modifier_tache', $tache->id) }}" class="btn-modifier"><ion-icon name="create-outline"></ion-icon></a>
                                  
                                  
                                  <form action="{{ route('taches.destroy', $tache->id) }}" method="POST" class="supprime">
                                  @csrf
                                  @method('DELETE')
                    ...
                    <div class="cardHeader">
                        <a href="{{ route('taches.creer_tache',$etape->id) }}" class="btn btn-primary mb-3">Ajouter une tache</a>
