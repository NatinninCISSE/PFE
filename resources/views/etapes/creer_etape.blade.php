...
<body>
    ...
    <div class="container">
        ...
        <form action="{{ route('etapes.store') }}" enctype="multipart/form-data" method="POST">
            <div>
              
            @csrf

            <select class="culture" id="culture" name="culture" class="form-control" required>
            ...
            <div class="form-group">
                <label for="date_debut_etape">Date debut</label>
                <input type="date" class="form-control" id="date_debut_etape" name="date_debut_etape" value="{{ old('date_debut_etape') }}">
            </div>
            <div class="form-group">
                <label for="date_fin_etape">Date fin</label>
                <input type="date" class="form-control" id="date_fin_etape" name="date_fin_etape" value="{{ old('date_fin_etape') }}">
            </div>
            <div class="form-group">
            ...
            <button class="btn btn-danger"><a href="{{ route('etapes') }}" >Retour</a></button>
        </form>
    </div>
    <!-- =========== Scripts =========  -->
