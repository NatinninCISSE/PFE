        ...
        <form action="{{ route('reclamations.store') }}" method="POST">
          <div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="objet_reclamation" name="objet_reclamation" value="{{ old('objet_reclamation') }}">
            </div>
            <div class="form-group">
                <label for="description_reclamation">Description</label>
                <textarea class="form-control" id="description_reclamation" name="description_reclamation">{{ old('description_reclamation') }}</textarea>
            </div>
