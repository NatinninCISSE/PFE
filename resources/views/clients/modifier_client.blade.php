            ...
            <div class="col s12">
                ...
                <form class="form-group" method="POST" action="/clients/{id}/modifier_client_traitement">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nom_client" name="nom_client" value="{{$clients->nom_client}}">
                        
                    </div>
                    <div class="mb-3">
                        <label for="prenom_client" class="form-label">Prenom</label>
                        <input type="text" class="form-control" id="prenom_client" name="prenom_client" value="{{$clients->prenom_client}}">
                        
                    </div>
                    <div class="mb-3">
                        <label for="adresse_client" class="form-label">adresse</label>
                        <input type="text" class="form-control" id="adresse_client" name="adresse_client" value="{{$clients->adresse_client}}">
                        
                    </div>
                    <div class="mb-3">
                        <label for="numero_client" class="form-label">numero</label>
                        <input type="text" class="form-control" id="numero_client" name="numero_client" value="{{$clients->numero_client}}">
                        
                    </div>
                    <div class="mb-3">
                        <label for="mail_client" class="form-label">mail</label>
                        <input type="text" class="form-control" id="mail_client" name="mail_client" value="{{$clients->mail_client}}">
                        
                    </div>
                    <div class="mb-3">
                        <label for="password_client" class="form-label">password</label>
