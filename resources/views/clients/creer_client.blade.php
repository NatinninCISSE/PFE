            ...
            <select class="dispositif" id="dispositif" name="dispositif" class="form-control" required>
                ...
                @endforeach
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nom_client" name="nom_client" placeholder="Entrez le nom du client">
                        
                    </div>
                    <div class="mb-3">
                        <label for="prenom_client" class="form-label">Prénom(s)</label>
                        <input type="text" class="form-control" id="prenom_client"name="prenom_client">
                        
                    </div>
                    <div class="mb-3">
                        <label for="numero_client" class="form-label">Numéro</label>
                        <input type="Number" class="form-control" id="numero_client" name="numero_client">
