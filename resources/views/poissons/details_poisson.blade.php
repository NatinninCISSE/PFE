                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="bouton">
                                  ...
                                  <a href="{{ route('steps.modifier_step', $step->id) }}" class="btn-modifier"><ion-icon name="create-outline"></ion-icon></a>
                                  
                                  
                                  <form action="{{ route('steps.destroy', $step->id) }}" method="POST" class="supprime">
                                  @csrf
                                  @method('DELETE')
...
$(document).ready(function() {
            $('form').submit(function(e) {
                e.preventDefault();
                swal({
                    title: "Êtes-vous sûr(e) de vouloir supprimer ce poisson?",
                    icon: "warning",
