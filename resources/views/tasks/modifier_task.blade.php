   ...
   <div class="container">
        <div class="row">
            <div class="col s12">
                ...
                <hr>
                <center>
                <form class="form-group" method="POST" enctype="multipart/form-data" action="/tasks/{id}/modifier_task_traitement">
                    @csrf

                    <input type="text" name="id" style="display:none;" value="{{$tasks->id}}">
                    <div class="mb-3">
                        <label for="nom_tache" class="form-label">Nom</label>
                        <input type="text" class="form-control" id="nom_tache" name="nom_tache" value="{{$tasks->nom_tache}}">
                        
                    </div>
                    <div class="mb-3">
                        <label for="description_tache" class="form-label">Description</label>
                        <input type="text" class="form-control" id="description_tache"name="description_tache" value="{{$tasks->description_tache}}">
                    ...
                    <a href="{{ route('tasks') }}" class="btn btn-danger">Retour</a>
                </form>
                </center>
            </div>
        </div>
