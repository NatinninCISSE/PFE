            ...
            <div class="details">
                <div class="recentOrders">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="bouton">
                                  ...
                                  <a href="{{ route('tasks.details_task', $task->id) }}" class="btn-voir" class="bouton"><ion-icon name="eye-outline"></ion-icon></a>
                                  <a href="{{ route('tasks.modifier_task', $task->id) }}" class="btn-modifier"><ion-icon name="create-outline"></ion-icon></a>
                                  
                                  
                                  <form action="{{ route('tasks.destroy', $task->id) }}" method="POST" class="supprime">
                                  @csrf
                                  @method('DELETE')
                                  <button type="submit" class="btn-supprimer" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cette tache?')" >
                    ...
                    <div class="cardHeader">
                        <a href="{{ route('tasks.creer_task',$step->id) }}" class="btn btn-primary mb-3">Ajouter une tache</a>
...
$(document).ready(function() {
            $('form').submit(function(e) {
                e.preventDefault();
                swal({
                    title: "Êtes-vous sûr(e) de vouloir supprimer cette etape?",
                    icon: "warning",
