   ...
   <div class="container">
        <div class="row">
            <div class="col s12">
                ...
                <hr>
                <center>
                <form class="form-group" method="POST"- enctype="multipart/form-data" action="/steps/{id}/modifier_step_traitement">
                    @csrf

                    <input type="text" name="id" style="display:none;" value="{{$steps->id}}">
                    <div class="mb-3">
                        <label for="nom_etape" class="form-label">Nom</label>
                        <input type="text" class="form-control" id="nom_etape" name="nom_etape" value="{{$steps->nom_etape}}">
                        
                    </div>
                    <div class="mb-3">
                        <label for="description_etape" class="form-label">Description</label>
                        <input type="text" class="form-control" id="description_etape"name="description_etape" value="{{$steps->description_etape}}">
