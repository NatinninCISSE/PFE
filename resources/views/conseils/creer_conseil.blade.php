    ...
    <div class="container">
        ...
        <form action="{{ route('conseils.store') }}" method="POST">
          <div>
                ...
                @csrf
                <select class="etape" id="etape" name="etape" class="form-control" required>
            ...
            <div class="form-group">
                <label for="contenu_conseil">Conseil</label>
                <input type="text" class="form-control" id="contenu_conseil" name="contenu_conseil" value="{{ old('contenu_conseil') }}">
            </div>
            <div class="form-group">
                <label for="description_conseil">Description</label>
                <textarea class="form-control" id="description_conseil" name="description_conseil">{{ old('description_conseil') }}</textarea>
            </div>
