            ...
            <div class="col s12">
                  ...
                  <form action="/clients/{id}/modifier_client_traitement" method="POST">
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="contenu_conseil" name="contenu_conseil" value="{{ $conseils->contenu_conseil }}">
                      </div>
                      <div class="form-group">
                          <label for="description_conseil">Description</label>
                          <textarea class="form-control" id="description_conseil" name="description_conseil">{{ $conseils->description_conseil }}</textarea>
                      </div>
