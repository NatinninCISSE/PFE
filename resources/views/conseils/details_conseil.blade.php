...
<body>
            ...
            <div class="details">
                <div class="recentOrders">
                    <div class="cardHeader">
                        ...
                        <a href="{{ route('etapes.creer_etape') }}" class="btn btn-primary mb-3">Ajouter une etape</a>
                    </div>
                    <table>
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="bouton">
                                  ...
                                  <a href="{{ route('etapes.modifier_etape', $etape->id) }}" class="btn-modifier"><ion-icon name="create-outline"></ion-icon></a>
                                  
                                  
                                  <form action="{{ route('etapes.destroy', $etape->id) }}" method="POST">
                                  @csrf
                                  @method('DELETE')
                                  <button type="submit" class="btn-supprimer" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cette etape?')">
    ...
    <div class="container">
        ...
        <p><strong>Conseil :</strong> {{ $conseil->nom_conseil }}</p>
        <p><strong>Etape :</strong> {{ $conseil->etapes->nom_etape }}</p>
        <p><strong>Description :</strong> {{ $conseil->description_conseil }}</p>
        <!-- Autres champs à afficher -->
        <a href="{{ route('conseils') }}" class="btn btn-danger">Retour</a>
    </div>
...
$(document).ready(function() {
            $('form').submit(function(e) {
                e.preventDefault();
                swal({
                    title: "Êtes-vous sûr(e) de vouloir supprimer cette reclamation?",
                    icon: "warning",
