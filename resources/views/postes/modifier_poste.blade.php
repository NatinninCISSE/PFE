   ...
   <div class="container">
        <div class="row">
            <div class="col s12">
                ...
                <hr>
                <center>
                <form class="form-group" method="POST" action="/postes/{id}/modifier_poste_traitement" enctype="multipart/form-data">
                    @csrf

                    <input type="text" name="id" style="display:none;" value="{{$postes->id}}">
                    <div class="mb-3">
                        <label for="contenu_poste" class="form-label">Message</label>
                        <input type="text" class="form-control" id="contenu_poste" name="contenu_poste" value="{{$postes->contenu_poste}}">
                        
                    </div>
                    
                    <input type="file" name="image" value="{{$postes->image_poste}}" enctype="multipart/form-data">
                    <br>
                    <button type="submit" class="btn btn-primary">Sauvegarder</button>
                    
                    <a href="{{ route('postes') }}" class="btn btn-danger">Retour</a>
                </form>
                </center>
            </div>
        </div>
