...
<body>
    ...
    <div class="container">
        ...
        <div>
            <img src="{{ env('URL_APP').$poste->image_poste }}" width="100px" height="100px">
        </div>
        <p><strong>Message :</strong> {{ $poste->contenu_poste }}</p>
        <p><strong>Auteur :</strong> {{ $poste->clients->nom_client }}</p>
        <p><strong>Date d'envoi :</strong> {{ $poste->created_at }}</p>
