    ...
    <div class="details">
                <div class="recentOrders">
                    ...
                    <div class="container1">
                      <div>
                        <h4><span class="h4">Nom de la culture : </span>  {{  $culture->nom_culture }}</h4>
                      </div>
                    ...
                    <table>
                        ...
                        @foreach ($culture->etapes as $etape)
                        <tbody>
                            <tr>
                                <td>{{ $etape->id }}</td>
                                ...
                                <td class="bouton">
                                  ...
                                  <form action="{{ route('etapes.destroy', $etape->id) }}" method="POST" class="supprime">
                                  @csrf
                                  @method('DELETE')
                    ...
                    <div class="cardHeader">
                        <a href="{{ route('etapes.creer_etape',$culture->id) }}" class="btn btn-primary mb-3">Ajouter une etape</a>
                    </div>
