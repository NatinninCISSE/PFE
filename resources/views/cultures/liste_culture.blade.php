        ...
        <div class="details">
                <div class="recentOrders">
                    <div class="cardHeader">
                        ...
                        <a href="{{ route('cultures.creer_culture') }}" class="btn btn-primary mb-3">Ajouter une culture</a>
                    </div>
                    <table>
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="bouton">
                                  ...
                                  <a href="{{ route('cultures.modifier_culture', $culture->id) }}" class="btn-modifier"><ion-icon name="create-outline"></ion-icon></a>
                                  
                                  
                                  <form class="supprime" action="{{ route('cultures.destroy', $culture->id) }}" method="POST">
                                  @csrf
                                  @method('DELETE')
                                  <button type="submit" class="btn-supprimer" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cette culture?')">
